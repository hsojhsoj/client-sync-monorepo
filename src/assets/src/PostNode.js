    ...
    return (
        ...
        >
            ...
            <div className="clisyc-post-node-header">
                <span className={`clisyc-node-icon dashicons ${data.parentIcon || 'dashicons-admin-generic'}`}></span>
                <span className="clisyc-post-node-parent-label">
                    {data.filterOrder}. {data.parentLabel}
                </span>
            </div>
            <div className="clisyc-post-node-label">
                <a href={data.editUrl} target="_blank" rel="noopener noreferrer" onClick={handleLinkClick}>
                    {data.label}
                </a>
            </div>
