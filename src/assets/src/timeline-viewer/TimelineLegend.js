                ...
                <div className="clisyc-timeline-legend-section">
                    ...
                    <div className="clisyc-timeline-legend-items">
                        {statusIndicators.map(status => (
                            <div key={status.key} className="clisyc-timeline-legend-item" title={status.description}>
                                <span 
                                ...
                                ></span>
                                <span className="clisyc-timeline-legend-label">{status.label}</span>
                            </div>
                        ))}
                    </div>
                </div>
                    ...
                    <div className="clisyc-timeline-legend-section">
                        ...
                        <div className="clisyc-timeline-legend-items">
                            {dimensionTypes.map(dimType => (
                                <div key={dimType.slug} className="clisyc-timeline-legend-item">
                                    <span className={`dashicons ${dimType.icon || 'dashicons-calendar-alt'}`}></span>
                                    <span className="clisyc-timeline-legend-label">
                                        {dimType.label_plural || dimType.label}
                                        {dimType.is_primary && (
                                            <span className="clisyc-timeline-legend-badge">Primary</span>
                                        )}
                                    </span>
                                </div>
                            ))}
