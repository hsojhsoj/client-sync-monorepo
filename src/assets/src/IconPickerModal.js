                    ...
                    {filteredIcons.length > 0 ? (
                        filteredIcons.map(iconClass => (
                            <div
                                ...
                                onKeyDown={(e) => e.key === 'Enter' && onSelect(iconClass)}
                            >
                                <span className={`dashicons ${iconClass}`}></span>
                                <span className="clisyc-icon-picker-label">{iconClass.replace('dashicons-', '')}</span>
                            </div>
                        ))
                    ) : (
                        <p>No icons found.</p>
